...
const Home: NextPage = () => {
  return (
    <div className='h-full w-full'>
      ...
      <div className="w-full h-40 absolute bg-cogo-primary dark:purple dark:bg-black">
        <div className="sm:ml-0 ml-5 mr-0 mt-3 md:pl-80 md:pr-80 sm:w-full h-full bg-cogo-primary dark:bg-black">
